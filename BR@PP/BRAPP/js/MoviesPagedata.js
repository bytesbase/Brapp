(function () {
    ...
    function generateSampleData() {
        ...
        var sampleItems = [
            ...
            { group: sampleGroups[2], title: "Movie", subtitle: "Item Subtitle: 3", recordType: RecordType1.SecImageBanner1, description: itemDescription, content: itemContent, backgroundImage: "../../images/MoviesPage/Pic4.png" },
    ...
    WinJS.Namespace.define("MoviesPagedata", {
        items: groupedItems,
